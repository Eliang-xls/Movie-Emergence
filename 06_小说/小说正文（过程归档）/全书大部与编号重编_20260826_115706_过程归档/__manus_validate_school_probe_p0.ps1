...
$reportPath = Join-Path $root '__manus_第四部学校节点P0实施后验证报告.md'
$files = @(
    '109_第四部_加密分区.md',
    '110_第四部_探针.md',
    '111_第四部_修复.md',
...
$lines.Add('## 人工核验结论')
$lines.Add('')
$lines.Add('本报告仅验证目标文件已变更、指定高风险表述未以原有形式残留。仍须进行人工通读，确认后续章节不反向重建“B1-07等于深蓝 / S-0947”“学生私跑探针”“A5判定意识”“PSCAR监听主体性”四条旧链。')
